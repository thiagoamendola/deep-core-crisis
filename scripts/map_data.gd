...
func create_random_map():
	var num_rooms = utils.normal_limits(NUMBER_ROOMS_MEAN, NUMBER_ROOMS_DEVIATION, 2, NUMBER_ROOMS_MEAN+2*NUMBER_ROOMS_DEVIATION)
...
func create_random_entrance_exit():
	...
	entrance = Vector2(rand_range(entrance_room.init_pos.x, entrance_room.init_pos.x + entrance_room.size.x), rand_range(entrance_room.init_pos.y, entrance_room.init_pos.y + entrance_room.size.y))
	exit = Vector2(rand_range(exit_room.init_pos.x, exit_room.init_pos.x + exit_room.size.x), rand_range(exit_room.init_pos.y, exit_room.init_pos.y + exit_room.size.y))
